...
public class _2013211392_阿尔斯兰_7_AddBookUI extends JFrame{
	...
	public _2013211392_阿尔斯兰_7_AddBookUI() throws HeadlessException {
		...
		add.addActionListener(event -> {
			try {
				_2013211392_阿尔斯兰_7_MainUI.controller.addBook(isbn.getText(), Double.parseDouble(price.getText()),
						name.getText(), comboTypesList.getSelectedIndex() + 1);
